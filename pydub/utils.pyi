...
@overload
def get_array_type(
    bit_depth: Literal[8, 16, 32], signed: bool = ...
) -> Literal["b", "h", "i", "B", "H", "I"]: ...
@overload  # fallback
def get_array_type(
    bit_depth: int, signed: bool = ...
) -> Literal["b", "h", "i", "B", "H", "I"]: ...
@overload
def get_min_max_value(
    bit_depth: Literal[8, 16, 32],
) -> tuple[Literal[-0x80], Literal[0x7F]] | tuple[
    Literal[-0x8000], Literal[0x7FFF]
...
def ratio_to_db(
    ratio: float, val2: float | None = ..., using_amplitude: bool = ...
) -> float: ...
def make_chunks(
    audio_segment: AudioSegment, chunk_length: float
) -> list[AudioSegment]: ...
